...
namespace QoLPrime.Content.Biomes
{
	...
	public class ExampleSurfaceBiome : ModBiome	
	{
		...
		public override ModWaterStyle WaterStyle => ModContent.Find<ModWaterStyle>("QoLPrime/ExampleWaterStyle"); // Sets a water style for when inside this biome
		public override ModSurfaceBackgroundStyle SurfaceBackgroundStyle => ModContent.Find<ModSurfaceBackgroundStyle>("QoLPrime/ExampleSurfaceBackgroundStyle");
