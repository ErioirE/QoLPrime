using QoLPrime.Common.Systems;
using QoLPrime.Content.BossBars;
using QoLPrime.Content.Items;
using QoLPrime.Content.Items.Consumables;
using QoLPrime.Content.Projectiles;
...
namespace QoLPrime.Content.NPCs.MinionBoss
{
	...
	public class MinionBossBody : ModNPC
	{
		...
		public override void SetStaticDefaults() {
			...
			NPCID.Sets.NPCBestiaryDrawModifiers drawModifiers = new NPCID.Sets.NPCBestiaryDrawModifiers(0) {
				CustomTexturePath = "QoLPrime/Assets/Textures/Bestiary/MinionBoss_Preview",
				PortraitScale = 0.6f,
		...
		public override void HitEffect(int hitDirection, double damage) {
			...
			if (NPC.life <= 0) {
				...
				int backGoreType = ModContent.Find<ModGore>("QoLPrime/MinionBossBody_Back").Type;
				int frontGoreType = ModContent.Find<ModGore>("QoLPrime/MinionBossBody_Front").Type;
