...
using QoLPrime.Content.Tiles.Furniture;
using QoLPrime.Content.Walls;
...
namespace QoLPrime.Content.Items.Ammo
{
	public class ExampleSolutionItem : ModItem
	{
		public override string Texture => QoLPrime.AssetPath + "Textures/Items/ExampleSolution";
	...
	{
		public override string Texture => QoLPrime.AssetPath + "Textures/Projectiles/ExampleSolution";
