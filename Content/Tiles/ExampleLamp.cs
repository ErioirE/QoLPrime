...
namespace QoLPrime.Content.Tiles
{
	...
	internal class ExampleLamp : ModTile
	{
		...
		public override void SetDefaults() {
			...
			// Assets
			if (!Main.dedServ) {
				flameTexture = ModContent.GetTexture("QoLPrime/Content/Tiles/ExampleLamp_Flame"); // We could also reuse Main.FlameTexture[] textures, but using our own texture is nice.
			}
		}
