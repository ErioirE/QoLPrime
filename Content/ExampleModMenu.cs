...
namespace QoLPrime.Content
{
	public class ExampleModMenu : ModMenu
	{
		private const string menuAssetPath = "QoLPrime/Assets/Textures/Menu"; // Creates a constant variable representing the texture path, so we don't have to write it out multiple times
